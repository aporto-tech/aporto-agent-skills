...
concept:
  id: undefinedplan-design-review
  name: Plan Design Review
...
This Aporto skill is adapted from the gstack open-source skill at `plan-design-review/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
