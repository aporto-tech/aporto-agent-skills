...
concept:
  id: undefinedbenchmark
  name: Benchmark
tags: [gstack, qa, performance]
when_to_use:
  - performance
  - benchmark
  - page speed
...
This Aporto skill is adapted from the gstack open-source skill at `benchmark/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
