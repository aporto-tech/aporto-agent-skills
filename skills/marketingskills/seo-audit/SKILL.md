...
concept:
  id: seo-audit
  name: SEO Audit
tags: [marketingskills, marketing, seo, audit]
when_to_use:
  ...
  - For adding structured data, see schema.
...
Use this Aporto agent skill when the user needs the SEO Audit workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/seo-audit/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
