...
concept:
  id: ad-creative
  name: AD Creative
tags: [marketingskills, marketing, ad, creative, paid-acquisition, content]
when_to_use:
  ...
  - Also use when the user mentions 'ad copy variations,' 'ad creative,' 'generate headlines,' 'RSA headlines,' 'bulk ad copy,' 'ad iterations,' 'creative testing,' 'ad performance optimization,' 'write me some ads,' 'Facebook ad copy,' 'Google ad headlines,' 'LinkedIn ad text,' or 'I need more ad variations.' Use this whenever someone needs to produce ad copy at scale or iterate on existing ads.
  - For campaign strategy and targeting, see ads.
...
Use this Aporto agent skill when the user needs the AD Creative workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/ad-creative/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
