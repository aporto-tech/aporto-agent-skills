...
concept:
  id: cro
  name: CRO
tags: [marketingskills, marketing, cro, lifecycle, analytics]
when_to_use:
  - "When the user wants to optimize, improve, or increase conversions on any marketing page or form — including homepage, landing pages, pricing pages, feature pages, lead capture forms, or contact forms.
  ...
  - For signup/registration flows, see signup.
...
Use this Aporto agent skill when the user needs the CRO workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/cro/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
