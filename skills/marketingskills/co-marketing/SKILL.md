---
id: marketingskills-co-marketing
name: CO Marketing
...
concept:
  id: co-marketing
  name: CO Marketing
tags: [marketingskills, marketing, co, paid-acquisition, analytics]
when_to_use:
  - "When the user wants to find co-marketing partners, plan joint campaigns, or brainstorm partnership opportunities.
  - the user says 'co-marketing,' 'partner marketing,' 'joint campaign,' 'who should we partner with,' 'integration marketing,' 'cross-promotion,' 'collaborate with another company,' 'partnership ideas,' or 'co-brand.' For customer referral programs, see referrals.
  - For launch-specific partnerships, see launch."
...
Use this Aporto agent skill when the user needs the CO Marketing workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/co-marketing/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
