...
source:
  ...
  path: skills/signup/SKILL.md
  priority: 100
---
# Signup

Use this Aporto agent skill when the user needs the Signup workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/signup/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
