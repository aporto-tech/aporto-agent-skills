...
concept:
  id: emails
  name: Emails
tags: [marketingskills, marketing, emails, lifecycle, paid-acquisition]
when_to_use:
  ...
  - Also use when the user mentions "email sequence," "drip campaign," "nurture sequence," "onboarding emails," "welcome sequence," "re-engagement emails," "email automation," "lifecycle emails," "trigger-based emails," "email funnel," "email workflow," "what emails should I send," "welcome series," or "email cadence." Use this for any multi-email automated flow.
  - For cold outreach emails, see cold-email.
  - For in-app onboarding, see onboarding.
...
source:
  ...
  path: skills/emails/SKILL.md
  priority: 100
---
# Emails

Use this Aporto agent skill when the user needs the Emails workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/emails/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
