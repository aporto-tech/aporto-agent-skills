...
concept:
  id: cold-email
  name: Cold Email
tags: [marketingskills, marketing, cold, email, lifecycle, paid-acquisition, content, sales]
when_to_use:
  - Write B2B cold emails and follow-up sequences that get replies.
  - the user wants to write cold outreach emails, prospecting emails, cold email campaigns, sales development emails, or SDR emails.
  - Also use when the user mentions "cold outreach," "prospecting email," "outbound email," "email to leads," "reach out to prospects," "sales email," "follow-up email sequence," "nobody's replying to my emails," or "how do I write a cold email." Covers subject lines, opening lines, body copy, CTAs, personalization, and multi-touch follow-up sequences.
  - For warm/lifecycle email sequences, see emails.
...
Use this Aporto agent skill when the user needs the Cold Email workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/cold-email/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
