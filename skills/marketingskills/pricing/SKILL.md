...
concept:
  id: pricing
  name: Pricing
tags: [marketingskills, marketing, pricing]
when_to_use:
  ...
  - For in-app upgrade screens, see paywalls."
...
Use this Aporto agent skill when the user needs the Pricing workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/pricing/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
