---
id: marketingskills-directory-submissions
...
concept:
  ...
  name: Directory Submissions
tags: [marketingskills, marketing, directory, submissions, seo, paid-acquisition]
when_to_use:
  ...
  - Also use when the user mentions "directory submissions," "submit to directories," "backlinks from directories," "list my product," "submit to Product Hunt," "BetaList," "TAAFT," "Futurepedia," "G2 listing," "Capterra listing," "AlternativeTo," "SaaSHub," "AI directories," "MCP registry," "agent directory," "dofollow backlinks," "launch directories," or "directory tracker." Use this whenever someone is planning the directory layer of a product launch or an ongoing backlink campaign.
  - For the broader launch moment, see launch.
  - For programmatic SEO pages that should live behind these backlinks, see programmatic-seo.
...
Use this Aporto agent skill when the user needs the Directory Submissions workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/directory-submissions/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
