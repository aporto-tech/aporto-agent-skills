...
concept:
  id: marketing-ideas
  name: Marketing Ideas
tags: [marketingskills, marketing, ideas, lifecycle, paid-acquisition, content]
when_to_use:
...
Use this Aporto agent skill when the user needs the Marketing Ideas workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/marketing-ideas/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
