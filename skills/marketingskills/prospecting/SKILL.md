---
id: marketingskills-prospecting
name: Prospecting
...
concept:
  id: prospecting
  name: Prospecting
tags: [marketingskills, marketing, prospecting, lifecycle, paid-acquisition, content, analytics, sales]
when_to_use:
  ...
  - Also use when the user mentions "prospecting," "build a prospect list," "find prospects," "find leads," "lead gen list," "find SaaS companies that," "find B2B companies," "find local businesses," "ICP-fit accounts," "who should we go after," "outbound list," "target account list," "find clients near me," "businesses without websites," "prospect research," or "qualified leads." Use this for the list-building and qualification phase.
  - For writing the outbound copy after the list is built, see cold-email.
  - For deep competitive research on specific accounts, see competitor-profiling.
...
source:
  ...
  path: skills/prospecting/SKILL.md
  priority: 100
---
# Prospecting

Use this Aporto agent skill when the user needs the Prospecting workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/prospecting/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
