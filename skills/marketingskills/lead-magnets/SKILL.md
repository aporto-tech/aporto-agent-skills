...
concept:
  id: lead-magnets
  name: Lead Magnets
tags: [marketingskills, marketing, lead, magnets, lifecycle, paid-acquisition, content]
when_to_use:
  - When the user wants to create, plan, or optimize a lead magnet for email capture or lead generation.
  - Also use when the user mentions "lead magnet," "gated content," "content upgrade," "downloadable," "ebook," "cheat sheet," "checklist," "template download," "opt-in," "freebie," "PDF download," "resource library," "content offer," "email capture content," "Notion template," "spreadsheet template," or "what should I give away for emails." Use this for planning what to create and how to distribute it.
  - For interactive tools as lead magnets, see free-tools.
  - For writing the actual content, see copywriting.
...
Use this Aporto agent skill when the user needs the Lead Magnets workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/lead-magnets/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
