...
when_to_use:
  ...
  - For A/B test measurement, see ab-testing.
...
Use this Aporto agent skill when the user needs the Analytics workflow from the Marketing Skills catalog.

## Source Snapshot

This Aporto skill is adapted from Corey Haines' Marketing Skills repository at `skills/analytics/SKILL.md`. Use it as an instruction layer. If real execution is needed, call an Aporto capability through the routing API.
